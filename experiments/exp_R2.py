...
from core.metrics import l1_distance, l2_distance, estimate_lipschitz_pairwise
...
# ------------------------------------------------------------
# Global plot style: Calibri + larger fonts
# ------------------------------------------------------------
...
def plot_R2_results_no_dots(
    ...
    # --------------------------------------------------------
    # Reduce spacing between title and panels,
    # and between the three panels
    # --------------------------------------------------------
...
def run_one_experiment(
    ...
    L_hat = estimate_lipschitz_pairwise(
        X_train,
        Y_train,
        rho
    )
    ...
    plot_R2_results_no_dots(
        ...
        save_path=save_path,
        title=(
            f"Closed-form reconstruction on $[-1,1]^2$, "
            f"$N_{{\\mathrm{{train}}}}={N_train}$"
        ),
    )
